...
//无序实现
(0, _index.preload)(imgs, {
    each: function each(count) {
        div.innerHTML = Math.round((count + 1) / len * 100) + '%';
        document.body.appendChild(div);
    },
    all: function all(count) {
...
var _commonUtils = __webpack_require__(0);

Object.defineProperty(exports, 'classOf', {
  enumerable: true,
  get: function get() {
    return _commonUtils.classOf;
  }
});
Object.defineProperty(exports, 'inherit', {
  enumerable: true,
  get: function get() {
    return _commonUtils.inherit;
  }
});
Object.defineProperty(exports, 'existy', {
  enumerable: true,
  get: function get() {
    return _commonUtils.existy;
  }
});
